export default function About() {
  let aboutMeItems: string[] = [
    ...
    "I try and prioritize simplicity in my solutions, understanding that while complexity comes easily, simplicity requires efford to identify, design, and implement. Balancing simplicity with business goals is often the greater challenge, and it's a puzzle I genuinely enjoy solving.",
    "Software engineering has always been a core part of my routine, whether it’s learning from the experiences of seasoned engineers and large enterprises, or working on personal projects with a hobby or two mixed in. My goal is to build solid, practical knowledge so that I can eventually give back by sharing what I’ve learned through technical articles to help other engineers grow.",
