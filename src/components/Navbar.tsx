...
export default function Navbar() {
  ...
  return (
    <div
      id="navbar"
      className="fixed top-0 left-0 w-full bg-[#738678] text-[#fffdd0] flex justify-between items-center px-6 py-4 transition-transform transform -translate-y-full z-50"
    >
