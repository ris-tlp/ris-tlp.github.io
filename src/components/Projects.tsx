      ...
      <section className="container p-4 space-y-8 h-fit">
        ...
        <div className="mx-15 my-15 md:my-0">
          <ProjectCard
            ...
            description="GenAI powered job tracker that extracts and analyzes job descriptions from image screenshots to summarize eligbility requirements using Tesseract OCR and LLMs in one click. "
            githubUrl="https://github.com/ris-tlp/ai-job-tracker"
            imageUrl="https://i.imgur.com/owDu8YO.png"
            techStack={["Python", "TypeScript", "LangChain", "Tesseract", "FastAPI", "React", "Redux", "RTK Query", "PostgreSQL", "Docker"]}
            isGithub={true}
            reverse={true}
          />
          <ProjectCard
