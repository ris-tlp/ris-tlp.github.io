      ...
      <div className="flex flex-col space-y-8">
        ...
        <div className="mx-15">
          ...
          <WorkCard
            ...
            dates="August 2021 - Dec 2022"
            location="Dhahran, KSA"
            description="Developed full-stack and business intelligence services for a national telecommunication research platform, enabling analysis field responses collected by agencies to support data-driven nationwide digital policy decisions."
